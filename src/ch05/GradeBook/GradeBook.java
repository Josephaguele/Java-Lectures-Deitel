package ch05.GradeBook;// Fig. 5.9 GradeBook.java
// GradeBook class uses switch satemetn to count letter grades
...
public class GradeBook
{
    ...
    public void displayGradeReport()
    {
        ...
        else // no grades were enterd, so output appropriate message
