package ch16; // StringIndexMethods.java
...
public class StringIndexMethods
{
    public static void main (String[]args)
    {
        ...
        System.out.printf(" c is located index %d\n", letters.indexOf('c'));

        System.out.printf(" a is located index %d\n", letters.indexOf('a', 1));

        System.out.printf(" $ is located index %d\n\n", letters.indexOf('$'));
        ...
        System.out.printf("\"def\" is located at lastIndex %d\n", letters.lastIndexOf("def", 25));

        System.out.printf("\"hello\" is located at lastIndex %d\n", letters.lastIndexOf("hello"));
    }  // end main
