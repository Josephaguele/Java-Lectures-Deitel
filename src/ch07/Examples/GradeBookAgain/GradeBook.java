package ch07.Examples.GradeBookAgain;//Fig 7.18 GradeBook.java
...
public class GradeBook
{
    ...
    {
        // getCourseName gets the name of teh course
    ...
    public int getMaximum()
    {
        ...
        for (int[] studentGrades: grades)
        {
            ...
            for (int grade: studentGrades)
            {
                // if grades less than highGrade, assign it to highGrade
                if (grade > highGrade)
                    highGrade = grade;
            } // end inner for
        } // end outer for
    ...
    public void outputGrades()
    {
        ...
        System.out.printf("            "); // align column heads
