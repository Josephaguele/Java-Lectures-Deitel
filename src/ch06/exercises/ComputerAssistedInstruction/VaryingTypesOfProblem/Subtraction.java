...
public class Subtraction {
    ...
    void difficultyRequiredbyUser(){
        ...
        System.out.println("You have opted to do the Subtraction test.");
        System.out.println("***************SUBTRACTION TEST WITH DIFFICULTY LEVELS**************");
    ...
    static void difficultylevelOne() {
        ...
        System.out.println("\n There are ten questions in this subtraction test ");
