...
public class Division {
    ...
    void difficultyRequiredbyUser(){
        ...
        System.out.println("You have opted to do the Division test.");
        System.out.println("***************DIVISION TEST WITH DIFFICULTY LEVELS**************");
    ...
    static void difficultylevelOne() {
        ...
        while (counter < 10) {
            ...
            double studentAnswer = sc.nextDouble();  // user prompt
